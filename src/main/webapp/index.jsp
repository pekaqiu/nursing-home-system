...
<div class="container">
    <div class="hero">
        <h2>融合适老化交互设计的养老院信息管理系统</h2>
        <p>本系统面向养老院基础业务管理场景，保留用户申请入住、管理员审核、护工登记入住与护理记录等核心功能，页面采用大字号、清晰配色和简洁操作流程，方便老人家属与院内人员使用。</p>
        <div class="actions">
    ...
    <div class="grid-2">
        <div class="card">
            <strong>养老院信息</strong>
            <p>提供舒适居住环境、日常生活照护、基础健康观察和温馨人文关怀，帮助老人安心生活。</p>
        </div>
        <div class="card">
            <strong>服务流程</strong>
            <p>注册登录后可提交入住申请，管理员审核通过后，由护工完成入住登记并持续维护护理记录。</p>
        </div>
    </div>
</div>
